...
Issues
------
Please report any issues to the Github project at `https://github.com/sprockets/sprockets.handlers.status/issues <https://github.com/sprockets/sprockets.handlers.status/issues>`_

Source
------
``sprockets.handlers.status`` source is available on Github at `https://github.com/sprockets/sprockets.handlers.status <https://github.com/sprockets/sprockets.handlers.status>`_

License
-------
``sprockets.handlers.status`` is released under the `3-Clause BSD license <https://github.com/sprockets/sprockets.handlers.status/blob/master/LICENSE>`_.
